...
$themename = "Magazinum Theme";
$shortname =  "wpzoom";

$options = array (

array(    "name" => "Magazinum Theme Settings",
        "type" => "title"),
...
array(    "name" => "<img align='left' style='padding:0px 3px 0 0;' src='$homepath/wpzoom_admin/images/icons/feed.png' />RSS Feed URL",
 ...
 array(  "name" => "Show blog posts on Homepage ('Other news')?",
         "id" => $shortname."_homepost_posts",
...
array(    "type" => "preheader",
          "name" => "Homepage Posts Options (applicable to 'Other News' posts)"),
...
array(    "name" => "Excerpt lenght for posts (words)",
        ...
        "id" => $shortname."_excerpt_home",
        "std" => "60",
        "type" => "text"),
 

array(    "type" => "preheader",
          "name" => "Archives Posts Options (Categories, Tags, Search Results)"),
...
array(  "name" => "Author Name",
         "id" => $shortname."_singlepost_auth_name",
		"options" => array('Show', 'Hide'),
		"std" => "Show",
		"type" => "select"), 
				
array(  "name" => "Author Information (at the end of post)",
...
array(    "name" => "Number of posts in slider",
        "desc" => "How many posts should appear in \"Featured Slider\" on the homepage? Default: 10.",
...
array(    "name" => "Slider content: marked by a TAG or posted in a special CATEGORY",
...
array(    "name" => "Show Featured Articles on Homepage (after Carousel)?",
         "id" => $shortname."_featart_show",
        "options" => array('Yes', 'No'),
        "std" => "Yes",
        "type" => "select"),

array(    "name" => "Number of Featured Posts",
        "desc" => "How many featured posts you want to have on the homepage? Default: 1.",
        "id" => $shortname."_featart_posts",
        "std" => "1",
        "type" => "text"),

array(    "name" => "Featured Posts: marked by a TAG or posted in a special CATEGORY",
        "desc" => "Do you want to mark featured posts by a special tag or by category/categories?",
        "id" => $shortname."_featart_type",
        "options" => array('Tag', 'Category'),
        "std" => "Tag",
        "type" => "select"),

array(    "name" => "Featured Posts Slug",
        "desc" => "If you selected <strong>\"Tag\"</strong> in the previous field, enter the slug for the tag(s) which will be used to make a post to appear in this section. <br /><b><i>Example:</b></i> if your tag is <i>'Top News'</i>, then the slug will be <i>top-news</i>.<br />You can use multiple tags, example: <i>featured, recommended-posts</i>.<br /><br />If you selected <strong>\"Category\"</strong> in the previous field, enter the ID of your \"Carousel\" category. <br />Example: <strong>21</strong><br />You can use multiple categories IDs, separated by comma. Example: <b>1,3,5</b>",
        "id" => $shortname."_featart_slug",
        "std" => "featured",
        "type" => "text"),
...
array(    "name" => "Show featured categories on homepage?",
        "desc" => "Do you want to show featured categories on the homepage? First post in every category appears with an image and an excerpt, the rest appear as a list.",
        "id" => $shortname."_featured_big_cats_show",
        "options" => array('Yes', 'No'),
        "std" => "Yes",
        "type" => "select"),
...
array(    "name" => "Featured Category 1",
        ...
        "id" => $shortname."_featured_big_category_1",
        "categoryids" => $catids,
...
array(    "name" => "Featured Category 2",
        ...
        "id" => $shortname."_featured_big_category_2",
        "categoryids" => $catids,
        "categorynames" => $catnames,
        "std" => "",
        "type" => "select-category"),
...
array(    "name" => "Featured Category 3",
        ...
        "id" => $shortname."_featured_big_category_3",
        "categoryids" => $catids,
        "categorynames" => $catnames,
        "std" => "",
        "type" => "select-category"),
...
array(    "name" => "Featured Category 4",
        ...
        "id" => $shortname."_featured_big_category_4",
        "categoryids" => $catids,
        "categorynames" => $catnames,
        "std" => "",
        "type" => "select-category"),
...
array(    "name" => "Featured Category 5",
        ...
        "id" => $shortname."_featured_big_category_5",
        "categoryids" => $catids,
        "categorynames" => $catnames,
        "std" => "",
        "type" => "select-category"),
...
array(    "name" => "Featured Category 6",
        ...
        "id" => $shortname."_featured_big_category_6",
        "categoryids" => $catids,
        "categorynames" => $catnames,
        "std" => "",
        "type" => "select-category"),
...
array(    "name" => "Featured Posts per Category",
        "desc" => "How many posts should appear in every \"Featured Category\" on the homepage? Default: 5 (1 big + 4 in list).",
        "id" => $shortname."_featured_big_categories_posts",
        "std" => "5",
        "type" => "text"),
...
array(    "name" => "Display Search Bar in the Header?",
...
array(    "name" => "Sidebar Banner HTML Code",
        "desc" => "Enter complete HTML code for your banner or Adsense code.<br />Recommended size: <strong> 250 &times; 200px</strong><br /><br /><em>Example:</em><br /><code>&lt;a href='http://www.wpzoom.com'&gt;&lt;img src='http://wpzoom.s3.amazonaws.com/wpzoom6/images/ads/300.png' /&gt;&lt;/a&gt;</code>",
...
<div id="zoomWrap">
  <div id="zoomHead">
    ...
    <div id="zoomInfo"><ul><li class="documentation"><a href="http://www.wpzoom.com/documentation/magazinum.pdf">Documentation</a></li><li class="support"><a href="http://www.wpzoom.com/forum" target="_blank">Support Forum</a></li></ul></div>
  </div>
...
<input type="hidden" name="action" value="save" />
 ...
 <?php
    ...
    if ( $_REQUEST['saved'] ) echo '<div id="message" class="updated fade"><p><strong>Options saved [w p l o c k e r . c o m]</strong></p></div>';
 ?>
